...
file_path_key_verstamp = "key_verstamp/key_verstamp.csv"
# Путь где лежит файл в котором сохранем результат работы процедуры
file_path_house_sales = "house_sales/house_sales"
# Путь где лежат данные для исходного файла
file_path_sales = "sales.csv"
...
def compute_house_sales(path_verstamp, path_sales, path_house_sales, url_api, **kwargs):
    ...
    if not sales.empty:
        ...
        path_house_sales = path_house_sales + key_verstamp_new["verstamp"] + ".csv"
